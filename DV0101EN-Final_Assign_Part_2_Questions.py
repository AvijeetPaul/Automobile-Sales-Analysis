...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == "Recession":
        ...
        return [
            html.Div(
                ...
                children=[html.Div(children=R_chart1), html.Div(children=R_chart1)],
                style={"display": "flex"},
            ),
            html.Div(
                className="chart-item",
                children=[html.Div(children=R_chart2), html.Div(children=R_chart2)],
                style={"display": "flex"},
            ),
            html.Div(
                className="chart-item",
                children=[html.Div(children=R_chart3), html.Div(children=R_chart3)],
                style={"display": "flex"},
            ),
            html.Div(
                className="chart-item",
                children=[html.Div(children=R_chart4), html.Div(children=R_chart4)],
                style={"display": "flex"},
            ),
        ]
    ...
    # Yearly Statistic Report Plots
        ...
        Y_chart2 = dcc.Graph(
            figure=px.line(
                mas, x="Month", y="Automobile_Sales", title="Yearly Automobile sales"
            )
        )
        ...
        Y_chart3 = dcc.Graph(
            figure=px.bar(
                ...
                x="Year",
                y="Automobile_Sales",
                title="Average number of vehicles sold during the given year {}".format(
                    input_year
                ),
            )
        )
        ...
        return [
            html.Div(
                className="chart-item",
                children=[html.Div(children=Y_chart1), html.Div(children=Y_chart1)],
                style={"display": "flex"},
            ),
            html.Div(
                className="chart-item",
                children=[html.Div(children=Y_chart2), html.Div(children=Y_chart2)],
                style={"display": "flex"},
            ),
            html.Div(
                className="chart-item",
                children=[html.Div(children=Y_chart3), html.Div(children=Y_chart3)],
                style={"display": "flex"},
            ),
            html.Div(
                className="chart-item",
                children=[html.Div(children=Y_chart4), html.Div(children=Y_chart4)],
                style={"display": "flex"},
            ),
        ]
